...
log_level = 'INFO'
load_from = 'D:/github/mmdetection/outputs/balloon/best_coco_bbox_mAP_epoch_50.pth'
resume = False
train_cfg = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data/balloon/',
        ann_file='train/via_region_data_coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data/balloon/',
        ann_file='val/via_region_data_coco.json',
...
num_epochs_stage2 = 5
launcher = 'none'
work_dir = './work_dirs\\rtmdet_tiny_1xb12-balloon'
